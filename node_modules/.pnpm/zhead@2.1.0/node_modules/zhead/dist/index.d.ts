...
type MetaProperties = 'fb:app:id' | 'og:article:author' | 'og:article:expiration_time' | 'og:article:modified_time' | 'og:article:published_time' | 'og:article:section' | 'og:article:tag' | 'og:book:author' | 'og:book:isbn' | 'og:book:release_data' | 'og:book:tag' | 'og:description' | 'og:determiner' | 'og:image:height' | 'og:image:secure_url' | 'og:image:type' | 'og:image:url' | 'og:image:width' | 'og:image' | 'og:locale:alternate' | 'og:locale' | 'og:profile:first_name' | 'og:profile:gender' | 'og:profile:last_name' | 'og:profile:username' | 'og:site:name' | 'og:title' | 'og:type' | 'og:url' | 'og:video:height' | 'og:video:secure_url' | 'og:video:type' | 'og:video:url' | 'og:video:width' | 'og:video';
interface Meta {
    /**
